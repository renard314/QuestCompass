...
class MercatorProjection {
   ...
   */
  MercatorProjection(GeoView view) {
    this.mView = view;
  }
  ...
  public float metersToPixels(float meters) {
    return (float) (meters * (1 / calculateGroundResolution(this.mView.getMapCenter()
        .getLatitude(), this.mView.getZoomLevel())));
  }
